...
import zjg.marketplace.core.valueObject.log.Log;
...
public class LokiLoggerImpl implements ILogger {
    ...
    @Override
    public <Origin> void info(Class<Origin> origin, String message, Object... obj) {
        var log = LogFactory.factory(LogLevel.INFO, origin, message, "N/A");
        send(log);
    }
    ...
    @Override
    public <Origin> void warning(Class<Origin> origin, String message, Object... obj) {
        var log = LogFactory.factory(LogLevel.WARNING, origin, message, "N/A");
        send(log);
    }
    ...
    @Override
    public <Origin> void error(Class<Origin> origin, String message, Object... obj) {
        var log = LogFactory.factory(LogLevel.ERROR, origin, message, "N/A");
        send(log);
    }
